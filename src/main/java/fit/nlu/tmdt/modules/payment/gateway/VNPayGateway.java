...
public class VNPayGateway {
    ...
    public String buildPaymentUrl(String orderId, Double amount, String orderInfo, String bankCode, String ipAddr) {
        ...
        return vnpayUrl + "/paymentv2/vpcpay.html?" + queryString + "&vnp_SecureHash=" + secureHash;
    }
    ...
    /**
     * Trích xuất tham số từ HttpServletRequest
     */
    ...
    /**
     * Kiểm tra giao dịch thành công (vnp_ResponseCode == "00")
     */
